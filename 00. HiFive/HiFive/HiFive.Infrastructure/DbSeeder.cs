...
public class DbSeeder
{
	public static async Task Seed(IUnitOfWork unit)
	{
		...
		Album ReolAlbum;
		Album LotusJuiceAlbum;
		Album DuaLipaAlbum;
		Album LynyrdSkynyrdAlbum;
		Album FleetwoodMacAlbum;
		Album PinkFloydAlbum;
		Album SabatonAlbum;
		...
		ImageFile duaPfp;
		ImageFile lynyrdPfp;
		ImageFile fleetwoodPfp;
		ImageFile pinkPfp;
		ImageFile sabatonPfp;

		ImageFile reolCover;
		ImageFile lotusCover;
		ImageFile duaCover;
		ImageFile lynyrdCover;
		ImageFile fleetwoodCover;
		ImageFile pinkCover;
		ImageFile sabatonCover;
