...
{
	class SpeakerValidator : ISpeakerValidator
	{
		public void Validate(ISpeaker speaker, SpeakerApprovalCriteria criteria)
		{
			...
			bool meetsRequirements = speaker.Experience > 10 || speaker.HasBlog || speaker.Certifications.Count() > 3 || speaker.Employer.Contains(speaker.Employer);
